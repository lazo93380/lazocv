...
?>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <button type="button" class="btn btn-primary" ><a href="?exp=new" style="color:white;">Ajouter Experience</a></button><br>
    ...
    <textarea name="description" id="description" cols="30" rows="10" value="<?=$description?>"></textarea><br><br>
